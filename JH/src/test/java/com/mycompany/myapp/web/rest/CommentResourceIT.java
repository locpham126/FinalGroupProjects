...
class CommentResourceIT {
    ...
    private static final Integer DEFAULT_THUMBS_UP = 1;
    private static final Integer UPDATED_THUMBS_UP = 2;
    ...
    public static Comment createEntity(EntityManager em) {
        Comment comment = new Comment().post(DEFAULT_POST).thumbsUp(DEFAULT_THUMBS_UP);
        return comment;
    }
    ...
    public static Comment createUpdatedEntity(EntityManager em) {
        Comment comment = new Comment().post(UPDATED_POST).thumbsUp(UPDATED_THUMBS_UP);
        return comment;
    }
    ...
    void createComment() throws Exception {
        ...
        assertThat(testComment.getPost()).isEqualTo(DEFAULT_POST);
        assertThat(testComment.getThumbsUp()).isEqualTo(DEFAULT_THUMBS_UP);
    }
    ...
    void getAllComments() throws Exception {
        ...
        restCommentMockMvc
            ...
            .andExpect(jsonPath("$.[*].thumbsUp").value(hasItem(DEFAULT_THUMBS_UP)));
    }
    ...
    void getComment() throws Exception {
        ...
        restCommentMockMvc
            ...
            .andExpect(jsonPath("$.thumbsUp").value(DEFAULT_THUMBS_UP));
    }
    ...
    void putExistingComment() throws Exception {
        ...
        updatedComment.post(UPDATED_POST).thumbsUp(UPDATED_THUMBS_UP);
        ...
        Comment testComment = commentList.get(commentList.size() - 1);
        assertThat(testComment.getPost()).isEqualTo(UPDATED_POST);
        assertThat(testComment.getThumbsUp()).isEqualTo(UPDATED_THUMBS_UP);
    }
    ...
    void partialUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.post(UPDATED_POST).thumbsUp(UPDATED_THUMBS_UP);
