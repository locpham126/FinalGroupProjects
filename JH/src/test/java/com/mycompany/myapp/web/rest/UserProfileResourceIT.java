...
class UserProfileResourceIT {
    ...
    void putExistingUserProfile() throws Exception {
        ...
        updatedUserProfile.userName(UPDATED_USER_NAME).firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).email(UPDATED_EMAIL);
    ...
    void partialUpdateUserProfileWithPatch() throws Exception {
        ...
        partialUpdatedUserProfile.userName(UPDATED_USER_NAME).lastName(UPDATED_LAST_NAME);
