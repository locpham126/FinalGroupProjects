    ...
    <Row>
      <Col md="8">
        <h2 data-cy="commentDetailsHeading">
          <Translate contentKey="jhApp.comment.detail.title">Comment</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="post">
              <Translate contentKey="jhApp.comment.post">Post</Translate>
            </span>
          </dt>
          ...
          <dt>
            <Translate contentKey="jhApp.comment.video">Video</Translate>
          </dt>
          <dd>{commentEntity.video ? commentEntity.video.id : ''}</dd>
          <dt>
            <Translate contentKey="jhApp.comment.postedBy">Posted By</Translate>
          </dt>
