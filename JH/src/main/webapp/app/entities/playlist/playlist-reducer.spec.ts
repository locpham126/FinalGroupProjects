...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './playlist.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PLAYLIST_LIST actions', async () => {
    ...
    it('dispatches FETCH_PLAYLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PLAYLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PLAYLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PLAYLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PLAYLIST actions', async () => {
      const expectedActions = [
        {
